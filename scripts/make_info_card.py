...
ROWS = [
    ("host",),
    ("kv", "Now", "Founder & AI Engineer @ EnsanAI"),
    ("kv", "Build", "Rayan — multi-agent OS for clinics"),
    ("kv", "Edu", "B.Sc. Mechatronics, AASTMT '28"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Core", "Python, TypeScript, Node.js"),
    ("kv", "Platform", "FastAPI, React, Next.js, Postgres, AWS"),
    ("kv", "LLMs", "OpenAI, Anthropic, Groq orchestration"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "18+ microservices — architecture to deployment"),
    ("bul", "Arabic/English · voice, RAG & billing engine"),
]
